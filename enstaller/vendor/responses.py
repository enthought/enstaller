...
from enstaller.vendor.requests.utils import cookiejar_from_dict
from enstaller.vendor.requests.exceptions import ConnectionError
from enstaller.vendor.requests.sessions import REDIRECT_STATI
...
class RequestsMock(object):
    ...
    def start(self):
        ...
        self._patcher = mock.patch('enstaller.vendor.requests.adapters.HTTPAdapter.send',
                                   unbound_on_send)
        self._patcher.start()
